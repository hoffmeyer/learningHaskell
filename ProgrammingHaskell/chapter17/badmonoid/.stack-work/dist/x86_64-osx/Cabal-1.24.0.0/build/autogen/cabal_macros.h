...
/* package badmonoid-0.1.0.0 */
#define VERSION_badmonoid "0.1.0.0"
#define MIN_VERSION_badmonoid(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "badmonoid-0.1.0.0-3YopvbiNKYcLLby0BmpW8E"

#define CURRENT_PACKAGE_KEY "badmonoid-0.1.0.0-3YopvbiNKYcLLby0BmpW8E"
